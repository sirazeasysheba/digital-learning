  ...
  return (
    <div className="footer mt-5 mb-1">
      ...
      <Col md={4} className="d-flex justify-content-center align-items-center">
          <div>
            <h1 className="footer-title text-white"> EasySheba </h1> 
        ...
        <Col md={4} className="mt-5 mb-2">
          ...
          <div className="address-icon text-center me-2">
           <FontAwesomeIcon icon={faMapMarkerAlt}  style={{marginTop:10}} /> 
           </div>
           <div style={{lineHeight:0.5}}><p>Assure M N Tower, Flat B1, House H/1,
           </p>
            <p> North South Road, Block H, Dhaka 1212 
            </p></div>
          </div>
          <div className="d-flex mb-2">  
           <div className="address-icon text-center me-2">
           <FontAwesomeIcon icon={faPhone} style={{fontSize:14,marginTop:10}}  className="fa-rotate-90" /> 
           </div>
          <div style={{lineHeight:0.5}}><p>+8801966-050506</p> 
          <p>+8801966-050506</p>
            </div>
          </div>
